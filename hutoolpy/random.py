...
def rand_datetime(time_from: datetime.datetime, time_to: datetime.datetime) -> datetime.datetime:
...
def rand_date(date_from: datetime.date, date_to: datetime.date) -> datetime.date:
    ...
    return rand_datetime(convert_date_to_datetime(date_from), convert_date_to_datetime(date_to)).date()
